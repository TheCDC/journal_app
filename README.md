...
![index page head](screenshots/Screenshot-2018-4-9_Journal_App(1))

![index page body](screenshots/Screenshot-2018-4-9_Journal_App(2))

![single entry view](screenshots/Screenshot-2018-4-9_Journal_App(3))
